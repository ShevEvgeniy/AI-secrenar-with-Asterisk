...
| `NODE-012-short-slot-turn-taking-polish` | `docs/nodes/NODE-012-short-slot-turn-taking-polish.md` | `feat/node-012-short-slot-turn-taking-polish` | Planned next | Polish NAME, CITY, and PHONE_CONFIRM short-slot recording-window pauses after NODE-011. | Pending |
