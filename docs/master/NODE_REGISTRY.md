...
| `NODE-015-production-server-side-stt-strategy` | `docs/nodes/NODE-015-production-server-side-stt-strategy.md` | `feat/node-015-production-server-side-stt-strategy` | Recommended next | Decide and validate the production server-side STT strategy after NODE-014 proved the media path. | Pending |
