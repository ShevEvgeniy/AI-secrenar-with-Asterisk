...
| `NODE-009-business-hours-and-after-hours-handoff` | `docs/nodes/NODE-009-business-hours-and-after-hours-handoff.md` | `feat/node-009-business-hours-and-after-hours-handoff` | Planned next | Detect working hours vs non-working hours and avoid live transfer after hours while still collecting callback data. | Pending |
