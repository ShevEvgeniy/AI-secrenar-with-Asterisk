...
| `NODE-014-true-live-ari-media-streaming-stt-proof` | `docs/nodes/NODE-014-true-live-ari-media-streaming-stt-proof.md` | `feat/node-014-true-live-ari-media-streaming-stt-proof` | Planned next | Test true live ARI media into streaming STT while the caller is still speaking. | Pending |
